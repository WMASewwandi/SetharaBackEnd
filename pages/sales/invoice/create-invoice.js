...
const InvoiceCreate = () => {
  ...
  const handleAddOutlet = (item) => {
    ...
    const isDuplicate = rows.some(row => row.stockBalanceId === item.stockBalanceId);
    // if (isDuplicate && AllowCostLessThanSelling) {
    //   toast.warning("This outlet is already added.");
    //   return;
    // }
