...
import { convertTo12Hour, convertTo24Hour } from "@/components/utils/formatHelper";
...
export default function EditTimeSlot({item, fetchItems }) {
  ...
  const handleSubmit = async (values) => {
    ...
    fetch(`${BASE_URL}/TimeSlot/UpdateTimeSlot`, {
      method: "POST",
